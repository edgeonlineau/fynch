  ...
  },
  {
    ...
    "valueValidators": [
      ...
      },
      {
        ...
        "errorMessage": "Enter an exact version such as 0.2.1 (no \"v\" prefix, no range)."
      }
    ],
    "help": "The exact npm version of @edgeonline/fynch to load, e.g. 0.2.1."
  },
  {
    "type": "SELECT",
    "name": "cdn",
...
- name: Defaults to the bundled latest version on jsDelivr
  code: |-
    ...
    assertThat(capturedUrl).isEqualTo(
      'https://cdn.jsdelivr.net/npm/@edgeonline/fynch@0.2.1/dist/fynch.js'
    );
...
- name: Builds an unpkg URL when selected
  code: |-
    ...
    assertThat(capturedUrl).isEqualTo(
      'https://unpkg.com/@edgeonline/fynch@0.2.1/dist/fynch.js'
    );
