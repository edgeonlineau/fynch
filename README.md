...
The **Variable** column is the exact Data Layer Variable path to use in GTM. `event` is
the only top-level key; every other value lives under the `fynch` namespace.
...
| `fynch.action`           | The action — one of the 14 below. Encodes the same value as the `event` name, exposed as a variable.                                                                                                                                                                                                               |
| `fynch.context`          | A single roll-up of the event's most identifying value, for mapping one GA4 dimension. See [The `context` roll-up](#the-context-roll-up) — including the PII caveat for contact actions.                                                                                                                           |
| `fynch.page_url`         | Full page URL (`window.location.href`) at the time of the event.                                                                                                                                                                                                                                                   |
| `fynch.page_title`       | Document title (`document.title`).                                                                                                                                                                                                                                                                                 |
| `fynch.page_path`        | URL path (`window.location.pathname`).                                                                                                                                                                                                                                                                             |
| `fynch.referrer`         | `document.referrer` (empty string if none).                                                                                                                                                                                                                                                                        |
| `fynch.timestamp`        | ISO 8601 timestamp of when the event fired.                                                                                                                                                                                                                                                                        |
| `fynch.provider`         | The detected platform/channel (e.g. `whatsapp`, `gravity-forms`, `calendly`).                                                                                                                                                                                                                                      |
| `fynch.form_id`          | Platform form identifier, when available.                                                                                                                                                                                                                                                                          |
| `fynch.form_name`        | Human-readable form name, when available.                                                                                                                                                                                                                                                                          |
| `fynch.lead_id`          | Submission / conversation / booking identifier, when the platform provides one.                                                                                                                                                                                                                                    |
| `fynch.link_url`         | The clicked link's `href`. For `mailto:`/`tel:`/`callto:`/`sms:` links only the address or number is sent (e.g. `+61298765432`, `sydney@biz.com`) — the scheme is dropped as redundant with the action, and any `?subject=`/`?body=` style parameters are stripped since prefilled content can carry visitor data. |
| `fynch.link_text`        | The link's visible text (trimmed, max 100 chars).                                                                                                                                                                                                                                                                  |
| `fynch.link_id`          | The link element's `id`.                                                                                                                                                                                                                                                                                           |
| `fynch.link_classes`     | The link element's class list.                                                                                                                                                                                                                                                                                     |
| `fynch.link_domain`      | Hostname of an external/outbound link.                                                                                                                                                                                                                                                                             |
| `fynch.file_name`        | Filename of a downloaded file (last URL path segment).                                                                                                                                                                                                                                                             |
| `fynch.file_extension`   | Extension of a downloaded file (without the leading dot).                                                                                                                                                                                                                                                          |
| `fynch.percent_scrolled` | Scroll-depth milestone reached: `25`, `50`, `75`, or `90`.                                                                                                                                                                                                                                                         |
